<?php ob_start() ?>
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img class="zmdi-hc-spin" src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/logo.svg" width="48" height="48" alt="Compass"></div>
            <p>Please wait...</p>
        </div>
    </div>
	...
	<nav class="navbar">
		<div class="col-12">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?= $_SERVER['BASE_URI'] ?>"><img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/logo.svg" width="30" alt="Compass"><span class="m-l-10">Compass</span></a>
			</div>
	...
	<aside id="leftsidebar" class="sidebar">
		...
		<div class="menu">
			<ul class="list">
				<li>
					<div class="user-info">
						<div class="image"><a href="profile.html"><img src="<?= $_SERVER['BASE_URI'] ?>src/static/img/photo.jpg" alt="User"></a></div>
						<div class="detail">
							<h4><?= $_SESSION['userObject']->getFirstname() .' '. $_SESSION['userObject']->getLastname() ?></h4>
						...
						<ul class="list-unstyled">
							<li class="online">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar4.jpg" alt="">
							...
							<li class="online">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar5.jpg" alt="">
										<div class="media-body">
							...
							<li class="offline">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar2.jpg" alt="">
										<div class="media-body">
							...
							<li class="me">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar1.jpg" alt="">
										<div class="media-body">
							...
							<li class="online">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar3.jpg" alt="">
										<div class="media-body">
					...
					<div class="card">
						...
						<ul class="list-unstyled">
							<li class="offline inlineblock">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar10.jpg" alt="">
										<div class="media-body">
											<span class="badge badge-outline status"></span>
										</div>
									</div>
							...
							<li class="offline inlineblock">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar6.jpg" alt="">
										<div class="media-body">
											<span class="badge badge-outline status"></span>
										</div>
									</div>
							...
							<li class="offline inlineblock">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar7.jpg" alt="">
										<div class="media-body">
											<span class="badge badge-outline status"></span>
										</div>
									</div>
							...
							<li class="offline inlineblock">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar8.jpg" alt="">
										<div class="media-body">
											<span class="badge badge-outline status"></span>
										</div>
									</div>
							...
							<li class="offline inlineblock">
								<a href="javascript:void(0);">
									<div class="media">
										<img class="media-object " src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar9.jpg" alt="">
										<div class="media-body">
											<span class="badge badge-outline status"></span>
										</div>
									</div>
					...
					<div class="card">
						...
						<div class="progress-container progress-primary">
							...
							<ul class="list-unstyled team-info">
								...
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar2.jpg" alt="Avatar">
								</li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar3.jpg" alt="Avatar">
								</li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar4.jpg" alt="Avatar">
								</li>
							</ul>
						</div>
						<div class="progress-container">
							...
							<ul class="list-unstyled team-info">
								<li class="m-r-15"><small>Team</small></li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar10.jpg" alt="Avatar">
								</li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar9.jpg" alt="Avatar">
								</li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar8.jpg" alt="Avatar">
								</li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar7.jpg" alt="Avatar">
								</li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar6.jpg" alt="Avatar">
								</li>
							</ul>
						</div>
						<div class="progress-container progress-warning">
							...
							<ul class="list-unstyled team-info">
								<li class="m-r-15"><small>Team</small></li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar5.jpg" alt="Avatar">
								</li>
								<li>
									<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar2.jpg" alt="Avatar">
								</li>
				...
				<div class="chat-widget">
					<ul class="chat-scroll-list clearfix">
						<li class="left float-left">
							<img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar3.jpg" class="rounded-circle" alt="">
							<div class="chat-info">
						...
						<li class="left float-left"> <img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">
						...
						<li class="left float-left"> <img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/xs/avatar1.jpg" class="rounded-circle" alt="">
