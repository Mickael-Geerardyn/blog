			...
			<div class="row">
				...
				<div class="col-lg-5 col-md-6 col-sm-12">
					<ul class="breadcrumb float-md-right">
						<li class="breadcrumb-item"><a href="<?= $_SERVER['BASE_URI'] ?>"><i class="zmdi zmdi-home"></i> Compass</a></li>
					...
					<div class="card">
						...
						<div class="body">
							<div class="p-15 xl-slategray">
								<span class="m-r-20"><i class="zmdi zmdi-label col-green m-r-5"></i>Web Design</span></a>
								<span class="m-r-20"><i class="zmdi zmdi-label col-red m-r-5"></i>Photography</span></a>
								<span class="m-r-20"><i class="zmdi zmdi-label col-amber m-r-5"></i>Technology</span></a>
								<span class="m-r-20"><i class="zmdi zmdi-label col-purple m-r-5"></i>Lifestyle</span></a>
								<span><i class="zmdi zmdi-label col-lime m-r-5"></i>Sports</span></a>
							</div>
							...
							<ul class="inbox-widget list-unstyled clearfix">
								<li class="inbox-inner"><a href="#">
										<div class="inbox-item">
											<div class="inbox-img"> <img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/sm/avatar1.jpg" class="rounded" alt=""> </div>
								...
								<li class="inbox-inner"> <a href="#">
										<div class="inbox-item">
											<div class="inbox-img"> <img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/sm/avatar2.jpg" class="rounded" alt=""> </div>
											<div class="inbox-item-info">
								...
								<li class="inbox-inner"> <a href="#">
										<div class="inbox-item">
											<div class="inbox-img"> <img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/sm/avatar3.jpg" class="rounded" alt=""> </div>
											<div class="inbox-item-info">
								...
								<li class="inbox-inner"> <a href="#">
										<div class="inbox-item">
											<div class="inbox-img"> <img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/sm/avatar4.jpg" class="rounded" alt=""> </div>
											<div class="inbox-item-info">
								...
								<li class="inbox-inner"> <a href="#">
										<div class="inbox-item">
											<div class="inbox-img"><img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/sm/avatar5.jpg" class="rounded" alt=""> </div>
											<div class="inbox-item-info">
								...
								<li class="inbox-inner"> <a href="#">
										<div class="inbox-item">
											<div class="inbox-img"> <img src="<?= $_SERVER['BASE_URI'] ?>src/assets/images/sm/avatar6.jpg" class="rounded" alt=""> </div>
											<div class="inbox-item-info">
